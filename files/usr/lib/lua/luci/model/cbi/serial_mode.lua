...
m = Map("serial", translate("NetCom"), translate("TCP/IP to Serial Gateway configuration."))

s = m:section(TypedSection, "iface", translate("Interfaces"))

s:option(DummyValue, "dev", translate("Serial Device"))
--s:option(DummyValue, "devtype", translate("Device Type"))
...
p = s:option(ListValue, "mode", translate("SW-Mode"))
--p:depends("mode2", "Selected by Software")
...
p3:value("-parenb", translate("None"))
p3:value("parenb -parodd", translate("Even"))
p3:value("parenb parodd", translate("Odd"))
...
p5:value("-ixon -crtscts", translate("None"))
p5:value("ixon -crtscts", "XON/XOFF")
p5:value("-ixon crtscts", "RTS/CTS")
